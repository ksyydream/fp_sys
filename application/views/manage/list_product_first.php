...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="<?php site_url('manage/list_product_first')?>" method="post">
		<div class="searchBar">
			<table class="searchContent" id="search_purchase_order">
				<tr>
					<td><label>一级类别名称：</label><input type="text" size="16" name="first_name" value="<?php echo $first_name;?>" /></td>
				</tr>
			</table>
			<div class="subBar">
				<ul>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="<?php echo site_url('manage/add_product_first')?>" target="dialog" rel="add_product_first" title="新建"><span>新建</span></a></li>
			<li><a class="edit" href="<?php echo site_url('manage/edit_product_first/{id}')?>" target="dialog" rel="add_product_first" warn="请选择一条记录" title="查看"><span>查看</span></a></li>
			<li><a class="delete" href="<?php echo site_url('manage/delete_product_first')?>/{id}" target="ajaxTodo"  title="确定要更改状态？" warn="请选择一条记录"><span>作废/启用</span></a></li>
		</ul>
	</div>
